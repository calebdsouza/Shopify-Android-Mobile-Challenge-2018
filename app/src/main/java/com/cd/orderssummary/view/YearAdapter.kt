...
class YearAdapter(private val yearDataset: ArrayList<Order>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): YearAdapter.ViewHolder {
        // create a new view
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var order: Order= yearDataset[position]
    ...
    override fun getItemCount() = if (yearDataset.size > 10) 10 else yearDataset.size
}